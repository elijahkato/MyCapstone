...
INSTALLED_APPS = [
    ...
    'drf_yasg',
    'inventory_app',  # Add the app to the list of installed apps
...
# settings.py
SWAGGER_SETTINGS = {
    'USE_SESSION_AUTH': False,  # This disables the session authentication in Swagger
...
AUTH_USER_MODEL = 'inventory_app.CustomUser'  # Set the custom user model
